...
package org.acumos.onboarding.logging;
...
public class OnboardingLogAdapter {
	 ...
	 *            non-null logger.
	 */
	public OnboardingLogAdapter(final Logger logger) {
	 ...
	 * @return this.
	 */
	public OnboardingLogAdapter entering(final RequestAdapter<?> request, String format, Object... arguments) {
	 ...
	 * @return this.
	 */
	public OnboardingLogAdapter entering(final HttpServletRequest request) {
		return this.entering(new HttpServletRequestAdapter(checkNotNull(request)), EMPTY_MESSAGE);
	}

	public OnboardingLogAdapter entering(final HttpServletRequest request, String format, Object... arguments) {
	 ...
	 * @return this.
	 */
	public OnboardingLogAdapter setResponseDescriptor(final ResponseDescriptor d) {
	 ...
	 * @return this.
	 */
	public OnboardingLogAdapter setEnteringMDCs(final RequestAdapter<?> request) {
	...
	public static class ResponseDescriptor {
		 ...
		 * @return this.
		 */
		public ResponseDescriptor setResponseStatus(final OnboardingLogConstants.ResponseStatus status) {
			this.mStatus = status;
			return this;
		}
		...
		public void setMDCs() {
			...
			if (!response.isEmpty())
				MDC.put(OnboardingLogConstants.MDCs.RESPONSE_CODE, response);
			if (!description.isEmpty())
				MDC.put(OnboardingLogConstants.MDCs.RESPONSE_DESCRIPTION, description);
			if (!severity.isEmpty())
				MDC.put(OnboardingLogConstants.MDCs.RESPONSE_SEVERITY, severity);
			if (!status.isEmpty())
				MDC.put(OnboardingLogConstants.MDCs.RESPONSE_STATUS_CODE, status);
		}
	}
